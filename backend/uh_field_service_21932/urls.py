"""uh_field_service_21932 URL Configuration
...
admin.site.site_header = "UH Field Service"
admin.site.site_title = "UH Field Service Admin Portal"
admin.site.index_title = "UH Field Service Admin"

# swagger
api_info = openapi.Info(
    title="UH Field Service API",
    default_version="v1",
    description="API documentation for UH Field Service App",
)
